...
async def cmd_help(message: Message):
    help_text = (
        ...
        "• <code>ловушка</code> — Установить/проверить ловушку (кулдаун 5 часов)\n"
        ...
        "<b>Ловушки:</b>\n"
        "• Капкан (🪤): 1 животное за 30 минут\n"
        "• Яма (🕳️): 2-7 животных за 20 минут\n"
        "• Автоматический капкан (⚙️): 8-13 животных за 10 минут\n"
        "• Кулдаун: 5 часов (можно пропустить за звёзды)\n\n"
        "<b>Прогресс:</b>\n"
