...
async def cmd_help(message: Message):
    help_text = (
        ...
        "• <code>исследуй</code> — Исследовать локацию (3 энергии, для квестов)\n"
        ...
        "• <code>ловушка</code> — Установить/проверить ловушку (13 энергии, кд 5 часов)\n"
        ...
        "<b>Ловушки:</b>\n"
        "• Капкан (🪤): 1 животное за 30 мин (доступен сразу)\n"
        "• Яма (🕳️): 2-7 животных за 20 мин (улучшение 15000💰)\n"
        "• Автокапкан (⚙️): 8-13 животных за 10 мин (улучшение 30000💰)\n"
        "• Улучшить: Инвентарь → 🪤 Улучшить ловушку\n"
        "• Энергия: 13 ед., Кулдаун: 5 часов (можно пропустить за ⭐)\n"
        "• Результат придет автоматически, когда ловушка сработает!\n\n"
        "<b>Прогресс:</b>\n"
