...
QUESTS_DATA = [
    ...
    # Rainforest quests - Тропический лес
    {
        "title": "Древесные лягушки",
        "description": "Убейте 25 древесных лягушек.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 55,
        "reward_exp": 420,
        "reward_coins": 340,
        "conditions": {"kill": {"animal": "Древесная лягушка", "count": 25}},
        "progress_reward": 10
    },
    {
        "title": "Колибри и бабочки",
        "description": "Убейте 20 колибри.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 56,
        "reward_exp": 470,
        "reward_coins": 380,
        "conditions": {"kill": {"animal": "Колибри", "count": 20}},
        "progress_reward": 12
    },
    {
        "title": "Попугаи Ара",
        "description": "Убейте 15 попугаев Ара.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 57,
        "reward_exp": 520,
        "reward_coins": 420,
        "conditions": {"kill": {"animal": "Попугай-ара", "count": 15}},
        "progress_reward": 13
    },
    {
        "title": "Ленивцы",
        "description": "Убейте 10 ленивцев.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 58,
        "reward_exp": 570,
        "reward_coins": 460,
        "conditions": {"kill": {"animal": "Ленивец", "count": 10}},
        "progress_reward": 14
    },
    {
        "title": "Тамарины и коати",
        "description": "Убейте 12 коати.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 59,
        "reward_exp": 620,
        "reward_coins": 500,
        "conditions": {"kill": {"animal": "Коати", "count": 12}},
        "progress_reward": 15
    },
    {
        "title": "Древесные кенгуру",
        "description": "Убейте 8 древесных кенгуру.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 60,
        "reward_exp": 670,
        "reward_coins": 540,
        "conditions": {"kill": {"animal": "Древесный кенгуру", "count": 8}},
        "progress_reward": 16
    },
    {
        "title": "Питоны джунглей",
        "description": "Убейте 6 питонов.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 61,
        "reward_exp": 720,
        "reward_coins": 580,
        "conditions": {"kill": {"animal": "Питон", "count": 6}},
        "progress_reward": 17
    },
    {
        "title": "Анаконды",
        "description": "Убейте 5 анаконд.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 62,
        "reward_exp": 770,
        "reward_coins": 620,
        "conditions": {"kill": {"animal": "Анаконда", "count": 5}},
        "progress_reward": 18
    },
    {
        "title": "Пантеры и оцелоты",
        "description": "Убейте 4 пантеры.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 63,
        "reward_exp": 820,
        "reward_coins": 660,
        "conditions": {"kill": {"animal": "Пантера", "count": 4}},
        "progress_reward": 19
    },
    {
        "title": "Казуары и гарпии",
        "description": "Убейте 3 казуара.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 64,
        "reward_exp": 870,
        "reward_coins": 700,
        "conditions": {"kill": {"animal": "Казуар", "count": 3}},
        "progress_reward": 20
    },
    {
        "title": "Тапиры тропиков",
        "description": "Убейте 2 тапира.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 65,
        "reward_exp": 920,
        "reward_coins": 740,
        "conditions": {"kill": {"animal": "Тапир", "count": 2}},
        "progress_reward": 21
    },
    {
        "title": "Легендарная анаконда",
        "description": "Убейте легендарную анаконду.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 66,
        "reward_exp": 1100,
        "reward_coins": 880,
        "conditions": {"kill": {"animal": "Легендарная анаконда", "count": 1}},
        "progress_reward": 22
    },
    {
        "title": "Дух дождевого леса",
        "description": "Убейте легендарного духа дождевого леса.",
        "quest_type": "main",
        "location": "rainforest",
        "required_level": 67,
        "reward_exp": 1400,
        "reward_coins": 1100,
        "conditions": {"kill": {"animal": "Дух дождевого леса", "count": 1}},
        "progress_reward": 25,
        "is_boss_quest": True,
        "boss_name": "Дух дождевого леса"
    },
    # Side quests for rainforest
    {
        "title": "Тропические трофеи",
        "description": "Принесите 15 шкур анаконды.",
        "quest_type": "side",
        "location": "rainforest",
        "required_level": 55,
        "reward_exp": 290,
        "reward_coins": 280,
        "conditions": {"collect": {"item": "шкура анаконды", "count": 15}},
        "progress_reward": 5,
        "is_repeatable": True
    },
    {
        "title": "Оперение Ара",
        "description": "Принесите 30 перьев попугая Ара.",
        "quest_type": "side",
        "location": "rainforest",
        "required_level": 57,
        "reward_exp": 310,
        "reward_coins": 300,
        "conditions": {"collect": {"item": "перо ара", "count": 30}},
        "progress_reward": 5,
        "is_repeatable": True
    },
    {
        "title": "Тропические хищники",
        "description": "Убейте 12 оцелотов.",
        "quest_type": "side",
        "location": "rainforest",
        "required_level": 63,
        "reward_exp": 330,
        "reward_coins": 320,
        "conditions": {"kill": {"animal": "Оцелот", "count": 12}},
        "progress_reward": 5,
        "is_repeatable": True
    },
    # North forest quests - Северный лес
    {
        "title": "Северные белки",
        "description": "Убейте 20 белок.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 60,
        "reward_exp": 480,
        "reward_coins": 390,
        "conditions": {"kill": {"animal": "Белка", "count": 20}},
        "progress_reward": 10
    },
    {
        "title": "Зайцы и рябчики",
        "description": "Убейте 18 зайцев.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 61,
        "reward_exp": 530,
        "reward_coins": 430,
        "conditions": {"kill": {"animal": "Заяц", "count": 18}},
        "progress_reward": 12
    },
    {
        "title": "Дятлы и сойки",
        "description": "Убейте 15 глухарей.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 62,
        "reward_exp": 580,
        "reward_coins": 470,
        "conditions": {"kill": {"animal": "Глухарь", "count": 15}},
        "progress_reward": 13
    },
    {
        "title": "Бобры севера",
        "description": "Убейте 10 бобров.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 63,
        "reward_exp": 630,
        "reward_coins": 510,
        "conditions": {"kill": {"animal": "Бобр", "count": 10}},
        "progress_reward": 14
    },
    {
        "title": "Зайцы-беляки",
    ...
    {
        "title": "Рыси и росомахи",
        "description": "Убейте 8 росомах.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 65,
        "reward_exp": 730,
        "reward_coins": 590,
        "conditions": {"kill": {"animal": "Росомаха", "count": 8}},
        "progress_reward": 16
    },
    {
        "title": "Стаи волков",
        "description": "Убейте 6 волков.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 66,
        "reward_exp": 780,
        "reward_coins": 630,
        "conditions": {"kill": {"animal": "Волк", "count": 6}},
        "progress_reward": 17
    },
    {
        "title": "Северные олени",
        "description": "Убейте 5 северных оленей.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 67,
        "reward_exp": 830,
        "reward_coins": 670,
        "conditions": {"kill": {"animal": "Северный олень", "count": 5}},
        "progress_reward": 18
    },
    {
        "title": "Лоси севера",
        "description": "Убейте 4 лося.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 68,
        "reward_exp": 880,
        "reward_coins": 710,
        "conditions": {"kill": {"animal": "Лось", "count": 4}},
        "progress_reward": 19
    },
    {
        "title": "Бурые медведи",
        "description": "Убейте 3 бурых медведя.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 69,
        "reward_exp": 930,
        "reward_coins": 750,
        "conditions": {"kill": {"animal": "Бурый медведь", "count": 3}},
        "progress_reward": 20
    },
    {
        "title": "Лесные бизоны и гризли",
        "description": "Убейте 2 гризли.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 70,
        "reward_exp": 980,
        "reward_coins": 790,
        "conditions": {"kill": {"animal": "Гризли", "count": 2}},
        "progress_reward": 21
    },
    {
        "title": "Легендарный медведь",
        "description": "Убейте легендарного медведя.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 71,
        "reward_exp": 1200,
        "reward_coins": 960,
        "conditions": {"kill": {"animal": "Легендарный медведь", "count": 1}},
        "progress_reward": 22
    },
    {
        "title": "Дух северного леса",
        "description": "Убейте легендарного духа северного леса.",
        "quest_type": "main",
        "location": "north_forest",
        "required_level": 72,
        "reward_exp": 1500,
        "reward_coins": 1200,
        "conditions": {"kill": {"animal": "Дух северного леса", "count": 1}},
        "progress_reward": 25,
        "is_boss_quest": True,
        "boss_name": "Дух северного леса"
    },
    # Side quests for north_forest
    {
        "title": "Северные трофеи",
        "description": "Принесите 12 медвежьих шкур.",
        "quest_type": "side",
        "location": "north_forest",
        "required_level": 60,
        "reward_exp": 320,
        "reward_coins": 310,
        "conditions": {"collect": {"item": "шкура медведя", "count": 12}},
        "progress_reward": 5,
        "is_repeatable": True
    },
    {
        "title": "Бобровые шкуры",
        "description": "Принесите 18 бобровых шкур.",
        "quest_type": "side",
        "location": "north_forest",
        "required_level": 63,
        "reward_exp": 340,
        "reward_coins": 330,
        "conditions": {"collect": {"item": "шкура бобра", "count": 18}},
        "progress_reward": 5,
        "is_repeatable": True
    },
    {
        "title": "Оленьи рога",
        "description": "Принесите 6 пар оленьих рогов.",
        "quest_type": "side",
        "location": "north_forest",
        "required_level": 67,
        "reward_exp": 360,
        "reward_coins": 350,
        "conditions": {"collect": {"item": "рога оленя", "count": 6}},
        "progress_reward": 5,
        "is_repeatable": True
    },
    # Ocean quests - Океан
    ...
    {
        "title": "Тропический лес хищники",
        "description": "Убейте 10 пантер.",
        "quest_type": "side",
        "location": "rainforest",
        "required_level": 55,
        "reward_exp": 310,
        "reward_coins": 300,
        "conditions": {"kill": {"animal": "Пантера", "count": 10}},
        "progress_reward": 4,
        "is_repeatable": True
    },
    {
        "title": "Северный лес хищники",
        "description": "Убейте 15 рысей.",
        "quest_type": "side",
        "location": "north_forest",
        "required_level": 60,
